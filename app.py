...
def generate_image(text_prompt, inference_steps, model_id, seed, height, width):
    global model
    ...
    image = generate(model[model_id], text_prompt, inference_steps, seed, height, width)
...
async def generate_image_handler(request):
    ...
    task = loop.run_in_executor(
        None, generate_image, text_prompt, inference_steps, model_id, seed, height, width
    )
